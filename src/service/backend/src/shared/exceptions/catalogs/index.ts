...
export * from '@/shared/exceptions/catalogs/shipping.exception';
export * from '@/shared/exceptions/catalogs/outbox.exception';
export * from '@/shared/exceptions/catalogs/system.exception';
