...
export class CreateCheckoutBffHandler
  implements ICommandHandler<CreateCheckoutBffCommand>
{
  constructor(private readonly commandBus: CommandBus) {}

  async execute(command: CreateCheckoutBffCommand): Promise<CreateCheckoutBffResult> {
