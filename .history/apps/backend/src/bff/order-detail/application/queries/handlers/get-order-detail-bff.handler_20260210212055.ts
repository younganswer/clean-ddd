...
import { GetOrderDetailBffQuery } from '../get-order-detail-bff.query';
...
export class GetOrderDetailBffHandler
  implements IQueryHandler<GetOrderDetailBffQuery>
{
  constructor(private readonly queryBus: QueryBus) {}

  async execute(query: GetOrderDetailBffQuery): Promise<OrderDetailBffView | null> {
    ...
    const paymentPromise = includePayment && order.paymentId
      ? this.queryBus.execute<GetPaymentIntentQuery, PaymentIntentView | null>(
