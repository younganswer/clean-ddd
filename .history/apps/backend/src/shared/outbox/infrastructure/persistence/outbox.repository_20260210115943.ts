...
import { OutboxEventDto } from '../../domain/dto/outbox-event.dto';
import { IOutboxRepository } from '../../domain/i.outbox.repository';
...
export class OutboxRepository implements IOutboxRepository {
  ...
  async unlock(uuid: string): Promise<void> {
    const em = this.emForContext();
    await em.nativeUpdate(OutboxEventSchema, { uuid }, { lockedUntil: null });
  }
