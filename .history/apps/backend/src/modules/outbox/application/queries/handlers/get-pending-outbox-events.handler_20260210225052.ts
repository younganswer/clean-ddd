...
export class GetPendingOutboxEventsHandler
  implements IQueryHandler<GetPendingOutboxEventsQuery, GetPendingOutboxEventsResult>
{
  constructor(
  ...
  async execute(query: GetPendingOutboxEventsQuery): Promise<GetPendingOutboxEventsResult> {
